  ...
  const entries: Partial<InventoryEntry>[] = [
    {
      ...
      kind: InventoryKind.PURCHASE,
      qtyDelta: 25,
      stockAfter: 25,
      unitCost: 90,
      totalCost: 2250,
      supplier: 'Distribuidora Kérastase MX',
      invoice: 'INV-2024-001',
      createdById: ely.id,
      createdAt: daysAgo(30),
    },
    {
      productId: acondicionador.id,
      kind: InventoryKind.PURCHASE,
      qtyDelta: 20,
      stockAfter: 20,
      unitCost: 100,
    ...
    {
      productId: tratamiento.id,
      kind: InventoryKind.PURCHASE,
      qtyDelta: 15,
      stockAfter: 15,
      unitCost: 150,
      totalCost: 2250,
      supplier: 'Olaplex México',
    ...
    },
    {
      ...
      unitCost: 0,
      totalCost: 0,
      reason: AdjustmentReason.MERMA,
      notes: '3 botellas vencidas',
      createdById: ely.id,
    ...
    },
    {
      ...
      unitCost: 0,
      totalCost: 0,
      reason: AdjustmentReason.USO,
      notes: 'Uso en demostración para clienta',
      createdById: ely.id,
      createdAt: daysAgo(5),
    },
    {
    ...
    },
    {
      ...
      unitCost: 0,
      totalCost: 0,
      reason: AdjustmentReason.DEVOLUCION,
      notes: 'Devolución de cliente',
      createdById: ely.id,
      createdAt: daysAgo(1),
    },
  ];
